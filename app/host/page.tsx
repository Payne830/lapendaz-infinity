    ...
    <div ref={setNodeRef} {...attributes} style={{ ...style, border: `1px solid ${editing ? accent + '60' : accent + '30'}`, borderRadius: 12, overflow: 'hidden' }}>
      ...
      <div className="relative group" style={{ minHeight: 220, background: bgStyle }}>
        ...
        {isImageSlide && slide.image_url && (
          <img src={slide.image_url} alt="" style={{ width: '100%', display: 'block' }} />
        )}
        {isImageSlide && !slide.image_url && (
              ...
              {editing ? (
                <div
                  ...
                  style={{
                    ...
                    cursor: 'text',
                    borderBottom: slide.image_url ? 'none' : `1px solid ${accent}50`,
                    paddingBottom: 2,
                    minHeight: '1.5em',
              ...
              {editing ? (
                <div
                  ...
                  style={{
                    ...
                    cursor: 'text',
                    borderBottom: slide.image_url ? 'none' : `1px solid ${accent}30`,
                    paddingBottom: 2,
                    minHeight: '2em',
